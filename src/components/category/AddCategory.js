...
const AddCategory = () =>{
    return(
        <main>
<h2 id="tituloS"  class="tituloS">Cadastro Categorias</h2>
                        ...
                        <div className='sgradeBotoes'>
                            ...
                            <tr id='as' class='traddAgenda'>
                                <td id='AddAgenda' className='as'>
                                    <button className='Adicionar' class="btn btn-success"  data-toggle="tooltip" data-html="true" title='Novo Cadastro'><Link to="/addcategory"><span class="material-icons">add</span></Link></button>
                                 </td>
                            
                                <td id='AddAgenda' className='as'>
                                   {/* spam de comentário   */}
                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="VOLTAR">
                                        <button className='Voltar' class="btn btn-success"><Link to="/category"><span class="material-icons">arrow_back</span></Link></button>
                                    </span>
                                </td>
                            </tr>
                                ...
                                <form method="post" acceptCharset="utf-8" autoComplete="off" role="form">
                                    ...
                                    <tr>
                                        <div className="divLinhaCadastro" class="form-group text required">
                                            <td className='tdcadastro'><label className="lblcadastro" for="nome">Titulo</label></td>
                                            < tr>  
                                    ...
                                    <tr>
                                        ...
                                        <td className='tdcadastro'><label className="lblcadastro"  for="celular">Descrição</label></td>
                                        < tr><td className='tdcadastro'><input className="imputcadastro" type="text" name="descricao"  id="iddescricao" data-toggle="tooltip" data-html="true" title='Preencher Descrição' /></td></tr>
                                        </div>
                                    </tr>  
                                    <tr>
                                        <div className="divLinhaCadastro" class="form-group text">
                                           ...
                                           < tr>
                                                <td className='tdcadastro'>
                                                    <input className="imputcadastro"   name="category"  id="category" data-toggle="tooltip" data-html="true" title='Preencher Categoria'/>
                                                </td>
                                            </tr>
                                        </div>
                                    </tr>  
                                    ...
                                    <tr>
                                        <div className="divLinhaCadastro"   class="form-group text">
                                                <td className='tdcadastro'>
                                                        <label className="lblcadastro"  for="celular">Colaborador</label>
                                                 </td>
                                            < tr> 
                                                    <td className='tdcadastro'>
                                                    <select name='categoria-service' className='imputcadastro' tabIndex="-1" aria-hidden ="true" data-toggle="tooltip" data-html="true" title='Selecione'>
                                                        ...
                                                        <option value>Richard Franklin</option>
                                                        <option value>Maximiliano</option>
                                                        <option value>Gabriel Negrelo</option>
                                                    </select>
                                                    </td>
                                            </ tr>
                                          </div>   
